#!/usr/bin/env python3
"""Test script for docling provider (Step 5 checklist)."""
...
try:
    from langextract_docling import doclingLanguageModel
except ImportError:
...
PROVIDER_CLS_NAME = "doclingLanguageModel"
PATTERNS = ['^docling']
...
print("Testing docling Provider - Step 5 Checklist:")
print("-" * 50)
...
try:
    ...
    provider = doclingLanguageModel(model_id=model_id)
